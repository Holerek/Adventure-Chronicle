...
class EditAdventureForm(forms.Form):
    edit_adventure_title = forms.CharField(max_length=128, label='New Title')
    edit_adventure_id = forms.IntegerField(widget=forms.NumberInput(attrs={'type': 'hidden'}))
